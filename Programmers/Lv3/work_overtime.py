...
'''
[ 접근방법 ]
남은 작업량의 제곱으로 야근지수를 산출하므로 남은 작업량의 최대값을 최소화 시키는 것이 중요하다.
예를 들면 10을 9로 줄일 경우, 100을 81로 줄이므로 야근지수는 총 19만큼 감소하는데 비해
4를 3으로 줄일 경우, 줄어든 야근지수는 겨우 7이다.
