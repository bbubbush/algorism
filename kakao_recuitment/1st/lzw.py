...
'''
[ 접근방법 ]
문제 해설은 아주 간단한 문제라고 한다...
푸는데 3시간은 넘게 걸렸다.
마지막 값 처리가 자꾸 범위를 벗어나서 맨 뒤에 끝남을 알리는 문자'9'를 더해서 풀었다.

솔직히 이것도 푼게 맞는지 확신이 안선다. 다른 TestCase에서 오류가 터질꺼같은데...

의사코드를 그대로 구현했다. 추가적인 설명은 의미가 없을꺼 같아 생략한다.
